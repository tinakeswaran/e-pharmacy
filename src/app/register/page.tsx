...
import { Pill, ShieldCheck, ArrowRight, Lock, User, Mail, Loader2 } from 'lucide-react';
    ...
    <div style={{ minHeight: '100vh', background: '#0f172a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
      <div className="animate-fade-in" style={{ maxWidth: '450px', width: '100%' }}>
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.5)', fontWeight: 600, fontSize: '1.1rem' }}>Create your health account</p>
        </div>
        ...
        <div className="glass-panel" style={{ padding: '3rem', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(20px)' }}>
          <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div>
              <label style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.8rem', fontWeight: 800, textTransform: 'uppercase', marginBottom: '0.75rem', display: 'block' }}>Username</label>
            ...
            <div>
              <label style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.8rem', fontWeight: 800, textTransform: 'uppercase', marginBottom: '0.75rem', display: 'block' }}>Email Address</label>
              <div style={{ position: 'relative' }}>
          ...
          <div style={{ marginTop: '2.5rem', textAlign: 'center' }}>
             <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.9rem', fontWeight: 600 }}>Already have an account? <Link href="/login" style={{ color: '#3b82f6', textDecoration: 'none', fontWeight: 800 }}>Sign In</Link></p>
          </div>
        </div>
      </div>
      <style jsx>{`
